...
plotly_jinja_data = {"fig":overall_fig.to_html(full_html=False, include_plotlyjs=True, div_id="plotDiv")}
#plotly_jinja_data = {"fig":detailed_fig.to_html(full_html=False, include_plotlyjs=False, div_id="plotDiv")}
